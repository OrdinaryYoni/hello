...
public class DiceGame3 {
	...
	public void mainGame() {
		...
		System.out.println("당신의 회복 포션 개수는... " + user.getHeal() + "개!");
...
class 몬스터{
	...
	public void dialogue(플레이어 user) {
		...
		if (luck == 89 || luck == 79 || luck == 78 || luck == 73) { //4% 확률
			System.out.println("난 지금까지 살면서 너같이 싸우지 않고 나와 대화하고싶어하는 애는 처음봐..");
	...
	public void fightStart(플레이어 user) {
		while(true) {
			...
			int select = game.intInput("1.공격  2.회복  3.대화 ");
...
class 플레이어{
	...
	public int getHeal() {return healItem;}
	public void setHeal(int heal) {this.healItem = heal;}
