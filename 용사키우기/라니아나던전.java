...
public class 라니아나던전 {
	...
	public 라니아나던전() {
		mops[0] = new 몬스터("오크", 1500, 70, 12, 550, 500);//이름, 체력, 공격력, (최대)레벨, 최대경험치, 최소경험치
		mops[1] = new 몬스터("미네린", 2000, 100, 15, 700, 600);
		mops[2] = new 몬스터("하데론", 2300, 200, 18, 800, 800);
		mops[3] = new 몬스터("오크 왕", 3000, 300, 20, 1000, 900);
	}
