...
public class 마이하스산 {
	몬스터[] mops = new 몬스터[4];
	public 마이하스산() {
		mops[0] = new 몬스터("하급 마족", 9000, 900, 45, 3500, 3400);//이름, 체력, 공격력, (최대)레벨, 최대경험치, 최소경험치
		mops[1] = new 몬스터("중급 마족", 11000, 950, 55, 4200, 4100);
		mops[2] = new 몬스터("마이하스 베어", 15000, 1100, 58, 4800, 4700);
		mops[3] = new 몬스터("단테", 20000, 2000, 60, 5500, 5500);
	}
